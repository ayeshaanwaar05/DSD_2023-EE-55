...
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { sel[2] }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
#For clock
...
#for write
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports {write}];
